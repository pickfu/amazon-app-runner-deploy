...
export async function run(): Promise<void> {
    ...
    try {
        ...
        if (!serviceArn) {
            ...
            info(`Service creation initiated with service ID - ${serviceId} and URL - ${serviceUrl}`)
            ...
            info(`Service update initiated with operation ID - ${serviceId} and URL - ${serviceUrl}`)
